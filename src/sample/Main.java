...
public class Main extends Application {
    ...
    static Scene sc,scene1,scene2,scene3;
    static Stage window;
    ...
    public void start(Stage primaryStage) throws Exception{
        Pane activePanee;
        activePanee = login(primaryStage);


        mainScene = new Scene(activePanee, 900, 650);
    ...
    static Pane login(Stage pS) throws FileNotFoundException {
                    ...
                    if(p1.length()>0 && p2.length()>0){
                        if(p1.equals(p2)){
                            ...
                            try {
                                ...
                                mainScene = new Scene(login(primaryStage), 900, 650);
                                primaryStage.setScene(mainScene);
                            } catch (SQLException throwables) {
