                ...
                if (compusername.getText().contains(".co.in")) {
                    try {
                        ...
                        if (checkuser1 && rs.getString("cpassword").equals(pass)) {
                            ...
                            String sql = "Select cName from companycred where CID = " + C_id;
                            ResultSet fetchCom = stmt.executeQuery(sql);
                            if(fetchCom.next()){
                                comName = fetchCom.getString(2);
                            }
                            String welstr = "Welcome " + comName;
                            welcome.setText(welstr);
